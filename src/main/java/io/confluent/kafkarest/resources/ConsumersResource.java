...
public class ConsumersResource {
  ...
  public void readTopicBinary(@javax.ws.rs.core.Context final HttpServletRequest httpRequest,
                              ...
                              @QueryParam("max_bytes") @DefaultValue("-1") final long maxBytes) throws Exception {
      runProxyQuery(new PrivilegedExceptionAction() {
          @Override
          public Object run() throws Exception {
  ...
  public void readTopicJson(@javax.ws.rs.core.Context final HttpServletRequest httpRequest,
                            final @Suspended AsyncResponse asyncResponse,
                            final @PathParam("group") String group,
                            final @PathParam("instance") String instance,
                            final @PathParam("topic") String topic,
  ...
  private <KafkaK, KafkaV, ClientK, ClientV> void readTopic(
      ...
      final @PathParam("topic") String topic,
      @QueryParam("max_bytes") @DefaultValue("-1") long maxBytes,
      Class<? extends ConsumerState<KafkaK, KafkaV, ClientK, ClientV>> consumerStateType, String user) {
